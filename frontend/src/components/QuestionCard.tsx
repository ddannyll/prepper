...
export function QuestionNumber({
  ...
  return (
    <div className="font-bold">
      <h1 className="inline text-4xl text-gray-800">Q{questionNum}&nbsp;</h1>
      <h2 className="inline text-xl text-gray-500">of {totalQuestionNum}</h2>
    </div>
  );
}
...
export function QuestionCardMainSection({
  tags,
  prompt,
  promptReadIndex = Infinity,
}: QuestionCardMainSectionProps) {
  return (
    <>
