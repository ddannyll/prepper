import { Container, Button, Text, Card, Divider, Group, Title, Blockquote, Badge, Space, Flex } from '@mantine/core';
...
export default function QuestionCard({
  ...
  return (
    <Container size="xs" p={40}>
      <Card withBorder radius="md" shadow='md'>
        <Group position='apart'>
          <Group spacing={9}>
            <Title order={1} pb={8}>Q{questionNum}</Title>
            <Title order={3} color='dimmed'>of {totalQuestionNum}</Title>
          </Group>
          <Text color='dimmed' italic fz="sm">generated by AI</Text>
        </Group>
        <Card.Section>
