import { IconArrowForward, IconKeyboard, IconMicrophone } from '@tabler/icons-react';
...
export default function AnswerControls({keyboardOn=false, onKeyboardClick, onSubmitClick, onMicClick}: AnswerControlsProps) {
  return <div className='inline-flex w-fit items-stretch divide-x rounded overflow-hidden shadow'>
