...
export default function Home() {
  ...
  const {currQuestion, currQuestionNum, totalQuestionNum, advanceQuestion} = useQuestionPlayer({questions})
  const {read, currWordIndex} = useQuestionReader({question: currQuestion?.questionPrompt || ''})
