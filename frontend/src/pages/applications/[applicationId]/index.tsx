...
export default function ApplicationById() {
  ...
  return (
    <div className="w-full h-full p-10 flex flex-col gap-6 items-center overflow-hidden">
      ...
      <ol className="grow flex flex-col w-72 gap-4 overflow-y-auto">
        {questionsData
          ...
          : [...Array(3)].map(() => (
              <Skeleton
                key={uuid()}
                className="h-[100px] border bg-white flex flex-col"
              >
      ...
      <div className="flex gap-2 items-center">
        <EditApplicationDialog name={appData?.name} id={applicationId} />
